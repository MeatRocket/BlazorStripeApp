...
export function createPaymentMethodServer(clientSecret) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, createPaymentMethod(clientSecret)];
                case 1: return [2, _a.sent()];
            }
        });
    });
}
function createPaymentMethod(clientSecret) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, stripeVariable.confirmCardPayment(clientSecret, {
                        payment_method: {
                            card: card
                        }
                    })];
